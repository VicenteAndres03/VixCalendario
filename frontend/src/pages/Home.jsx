...
function Home(){
    ...
    return (
        <div className={`${darkMode ? "bg-gray-950" : "bg-gray-50"} min-h-screen overflow-hidden transition-colors duration-500`}>
                        ...
                        >
                            ...
                            <ul className="space-y-3 mb-8">
                                {plan.caracteristicas.map((c, i) => (
                                    <li key={i} className={`text-sm ${darkMode ? "text-gray-300" : "text-gray-600"}`}>{c}</li>
                                ))}
                            </ul>
